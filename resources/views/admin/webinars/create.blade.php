...
@section('page-title', 'Add Webinar')
...
<style>
    ...
    /* Professional Banner Dropzone/Preview styling */
...
<div class="container-fluid py-2">
    <div class="form-card">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="fw-bold mb-1" style="color: #0f172a; letter-spacing: -0.5px;">Schedule New Webinar</h4>
                <p class="text-muted small mb-0">Fill in the details to launch and track a live trading or prop firm session.</p>
            </div>
        ...
        <form id="webinarForm" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-8">
                    ...
                    <input type="text" name="title" id="title" class="form-control" placeholder="e.g., Advanced Options Trading Strategies">
                ...
                <div class="col-md-5">
                    ...
                    <input type="text" name="speaker_name" id="speaker_name" class="form-control" placeholder="Enter speaker name">
                ...
                <div class="col-md-4">
                    ...
                    <input type="datetime-local" name="webinar_date" id="webinar_date" class="form-control">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" name="duration_minutes" id="duration_minutes" class="form-control" value="60" min="1">
                ...
                <div class="col-12">
                    ...
                    <input type="url" name="meeting_link" id="meeting_link" class="form-control" placeholder="https://zoom.us/j/... or live stream URL">
                ...
                <div class="col-md-7">
                    ...
                    <textarea name="description" id="description" class="form-control" rows="8" placeholder="Outline the topics covered in this masterclass..."></textarea>
                ...
                <div class="col-md-5">
                    ...
                    <div class="image-preview-wrapper" onclick="$('#bannerInput').click();">
                        <div class="upload-placeholder" id="uploadText">
                            ...
                            <span class="fw-semibold text-primary">Click to upload</span> or drag and drop<br>
            ...
            <div class="mt-4 pt-2 text-end">
                <button type="submit" id="submitBtn" class="btn btn-save">
                    <i class="fa fa-calendar-plus me-2"></i> Schedule Webinar
                </button>
            </div>
...
$(document).ready(function () {
    ...
    // ✅ INSTANT BANNER IMAGE PREVIEW ENGINE
    ...
    $("#webinarForm").validate({
        ...
        submitHandler: function (form) {
            ...
            $('#submitBtn').prop('disabled', true).html('<i class="fa-solid fa-spinner fa-spin me-2"></i> Processing Scheduling...');
            ...
            $.ajax({
                ...
                error: function (xhr) {
                    $('#submitBtn').prop('disabled', false).html('<i class="fa fa-calendar-plus me-2"></i> Schedule Webinar');
                    ...
                    if (xhr.status === 422) {
                        ...
                        Swal.fire({
                            ...
                            text: xhr.responseJSON.message || 'Something went wrong while synchronizing with the database.'
                        });
                    }
                }
            });
